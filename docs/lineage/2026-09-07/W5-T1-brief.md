...
Evidence artifact: docs/work/W5-T1/acceptance.md
...
```text
docs/work/W5-T1/acceptance.md
```

### 2

```text
docs/work/W5-T1/scope-and-integration.md
```

### 3

```text
fixtures/staged-compatibility/**
```

### 4

```text
src/planning/migration-order/**
```

### 5

```text
tests/planning/migration-order/**
```

### 6

```text
tests/task-scenarios/W5-T1/**
```
