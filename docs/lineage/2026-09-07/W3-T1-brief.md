...
Evidence artifact: docs/work/W3-T1/acceptance.md
...
```text
docs/work/W3-T1/acceptance.md
```

### 2

```text
docs/work/W3-T1/scope-and-integration.md
```

### 3

```text
fixtures/differential-counterexamples/**
```

### 4

```text
src/differential/comparison/**
```

### 5

```text
src/differential/isolated-execution/**
```
...
```text
tests/differential/isolated-execution/**
```

### 8

```text
tests/task-scenarios/W3-T1/**
```
