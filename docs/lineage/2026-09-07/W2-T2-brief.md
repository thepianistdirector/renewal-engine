...
```text
2. W2 — Understand and propose a narrow change
```
...
Wave: W2
Prerequisites: W1-T1, W1-T2, W2-T1
...
Evidence artifact: docs/work/W2-T2/acceptance.md
...
```text
docs/work/W2-T2/acceptance.md
```

### 2

```text
docs/work/W2-T2/scope-and-integration.md
```

### 3

```text
fixtures/recipe-idempotence/**
```

### 4

```text
fixtures/reference-migration/**
```

### 5

```text
src/recipes/reference-migration/**
```

### 6

```text
tests/recipes/reference-migration/**
```

### 7

```text
tests/task-scenarios/W2-T2/**
```
