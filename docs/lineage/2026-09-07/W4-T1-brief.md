...
Evidence artifact: docs/work/W4-T1/acceptance.md
...
```text
docs/work/W4-T1/acceptance.md
```

### 2

```text
docs/work/W4-T1/scope-and-integration.md
```

### 3

```text
examples/recipes/second-reference/**
```

### 4

```text
fixtures/recipe-compatibility/**
```
