...
Evidence artifact: docs/work/W2-T1/acceptance.md
...
```text
docs/work/W2-T1/acceptance.md
```

### 2

```text
docs/work/W2-T1/migration-impact-map.md
```

### 3

```text
docs/work/W2-T1/unsupported-patterns.md
```
