...
Evidence artifact: docs/work/W6-T1/acceptance.md
...
```text
docs/work/W6-T1/acceptance.md
```

### 2

```text
docs/work/W6-T1/scope-and-integration.md
```

### 3

```text
examples/maintainer-pilot/**
```

### 4

```text
fixtures/maintainer-pilot-regressions/**
```

### 5

```text
tests/task-scenarios/W6-T1/**
```
