...
```text
tsk_4094a1ff51d72e4a7b4a14420a3f3c48
```
...
```text
6. W6 — An ecosystem that stays maintainable
```
...
```text
tsk_c5c45d54c7d504d440dc18fdd697b84a
```
...
Wave: W6
Prerequisites: W5-T1, W5-T2, W6-T1
...
Evidence artifact: docs/work/W6-T2/acceptance.md
...
```text
docs/work/W6-T2/acceptance.md
```

### 2

```text
docs/work/W6-T2/scope-and-integration.md
```

### 3

```text
examples/recipe-maintenance/**
```

### 4

```text
fixtures/catalog-regressions/**
```
...
```text
tests/recipes/catalog/**
```

### 7

```text
tests/task-scenarios/W6-T2/**
```
