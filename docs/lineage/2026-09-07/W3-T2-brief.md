...
```text
tsk_7e9f19f4a3e6ff05eb357075dac35818
```
...
```text
3. W3 — Compare behavior, including failures
```
...
```text
tsk_17179248999bbb2086133ef8ed4cb216
```

### 2

```text
tsk_a9e192b7ec0fa463c48c7b7b3aea4386
```

### 3

```text
tsk_89e135a4cdda5620e7737ed426e59e3c
```
...
Wave: W3
Prerequisites: W2-T1, W2-T2, W3-T1
...
Evidence artifact: docs/work/W3-T2/acceptance.md
...
```text
docs/work/W3-T2/acceptance.md
```

### 2

```text
docs/work/W3-T2/scope-and-integration.md
```

### 3

```text
examples/migration-review/**
```

### 4

```text
src/recovery/migration-rollback/**
```

### 5

```text
src/review/migration-changes/**
```

### 6

```text
tests/recovery/migration-rollback/**
```

### 7

```text
tests/review/migration-changes/**
```

### 8

```text
tests/task-scenarios/W3-T2/**
```
