...
def main():
    ...
    source_files={}
    for name in ['README.md','CONTRIBUTING.md','LICENSE','THIRD_PARTY.md','ROADMAP.md','TASKS.md','project-plan.json','task-contracts.json','install.py','HANDOFF.md']:
        source_files[name]=(ROOT/name).read_bytes()
    for directory in ['renewal_engine','tests','tools','docs/decisions','docs/evidence','docs/planning','docs/publication','docs/lineage','docs/references']:
