...
```text
4. W4 — Recipes other maintainers can trust
```
...
Evidence artifact: docs/work/W4-T2/acceptance.md
...
```text
docs/work/W4-T2/acceptance.md
```

### 2

```text
docs/work/W4-T2/scope-and-integration.md
```

### 3

```text
examples/local-operation/**
```

### 4

```text
src/adapters/optional-model/**
```

### 5

```text
src/local/migration-runner/**
```

### 6

```text
src/ui/model-data-boundary/**
```

### 7

```text
tests/adapters/optional-model/**
```

### 8

```text
tests/local/migration-runner/**
```

### 9

```text
tests/task-scenarios/W4-T2/**
```

### 10

```text
tests/ui/model-data-boundary/**
```
