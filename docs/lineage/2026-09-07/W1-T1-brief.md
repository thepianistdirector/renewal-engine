...
```text
- openai / gpt-6-astra · minimum effort medium
- anthropic / claude-fable-5-1 · minimum effort medium
```
...
Wave: W1
Prerequisites: None; maintainer scope review first
...
Maintainer accepts the scoped design protocol; this is not product implementation.
...
Evidence artifact: docs/work/W1-T1/acceptance.md
...
```text
docs/work/W1-T1/acceptance.md
```

### 2

```text
docs/work/W1-T1/baseline-evidence.md
```

### 3

```text
docs/work/W1-T1/reference-migration.md
```
